...
__version__ = '$Id: wikipedia_family.py 9497 2011-09-03 15:43:38Z xqt $'
...
class Family(family.Family):
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'sl', 'vo', 'eu', 'war', 'hr', 'hi', 'et', 'az', 'kk', 'gl',
            'simple', 'nn', 'new', 'th', 'el', 'roa-rup', 'la', 'tl', 'ht',
            'ka', 'te', 'mk', 'sh', 'pms', 'ceb', 'be-x-old', 'br', 'jv', 'lv',
            'ta', 'mr', 'cy', 'sq', 'lb', 'be', 'is', 'bs', 'oc', 'yo', 'an',
            'bpy', 'mg', 'bn', 'io', 'sw', 'fy', 'lmo', 'gu', 'ml', 'pnb', 'af',
            'nds', 'scn', 'ur', 'qu', 'ku', 'zh-yue', 'ne', 'ast', 'su', 'hy',
            'nap', 'ga', 'cv', 'bat-smg', 'tt', 'wa', 'diq', 'am', 'kn', 'als',
            'tg', 'bug', 'zh-min-nan', 'vec', 'roa-tara', 'yi', 'gd', 'arz',
            'os', 'sah', 'uz', 'pam', 'sco', 'my', 'mi', 'hsb', 'nah', 'li',
            'mn', 'co', 'gan', 'glk', 'ia', 'si', 'hif', 'sa', 'bcl', 'fo',
            'mrj', 'fiu-vro', 'ckb', 'nds-nl', 'bar', 'vls', 'tk', 'gv', 'ilo',
            'se', 'map-bms', 'dv', 'nrm', 'ba', 'pag', 'rm', 'mzn', 'bo', 'udm',
            'ps', 'fur', 'wuu', 'km', 'ug', 'csb', 'mt', 'lij', 'koi', 'pi',
            'ang', 'bh', 'kv', 'sc', 'lad', 'nov', 'rue', 'zh-classical', 'mhr',
            'cbk-zam', 'ksh', 'so', 'kw', 'frp', 'nv', 'hak', 'pa', 'szl',
            'ext', 'stq', 'ie', 'xal', 'rw', 'haw', 'ln', 'pdc', 'pcd', 'pfl',
            'krc', 'ky', 'to', 'crh', 'ace', 'or', 'myv', 'eml', 'gn', 'frr',
            'ay', 'arc', 'ce', 'kl', 'pap', 'bjn', 'jbo', 'wo', 'lbe', 'tpi',
            'mdf', 'kab', 'gag', 'ty', 'srn', 'zea', 'dsb', 'xmf', 'lo', 'ab',
            'av', 'ig', 'na', 'tet', 'kg', 'mwl', 'as', 'kaa', 'ltg', 'rmy',
            'cu', 'kbd', 'sm', 'sd', 'bm', 'bi', 'ik', 'ss', 'iu', 'pih', 'ks',
            'pnt', 'za', 'chr', 'cdo', 'ee', 'got', 'ha', 'ti', 'bxr', 'om',
            'zu', 'sn', 've', 'ts', 'rn', 'sg', 'cr', 'dz', 'tum', 'lg', 'ch',
            'fj', 'ny', 'ff', 'st', 'xh', 'tn', 'chy', 'ki', 'ak', 'tw',
        ]
