...
#
__version__ = '$Id: welcome.py 9482 2011-08-29 16:32:37Z xqt $'
#
...
netext = {
    'commons': {'_default': u'{{Welcome}}<div align=right>%s</div>', } ,
    'wikipedia': {
        'am': u'{{subst:Welcome}} %s',
        'ar': u'{{subst:ترحيب}} %s',
        'da': u'{{velkommen|%s}}',
        'de': u'{{subst:Hallo}} %s',
        'en': u'{{Welcome}}<div align=right>%s</div>',
        'fa': u'{{جا:خوشامد}} %s',
...
class Global(object):
    ...
    timeRecur = 5        # how much time (sec.) the bot sleeps before restart
